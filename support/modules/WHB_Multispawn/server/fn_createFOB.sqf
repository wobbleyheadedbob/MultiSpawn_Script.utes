...
Description:
Serverside call to create a static FOB.
Called server-side just in case the client machine disconnects or crashes during the parameter defined delay.
...
if !isDedicated then 
{
	[1, _fobHQ] call MSO_fnc_client_syncHQState;
};
